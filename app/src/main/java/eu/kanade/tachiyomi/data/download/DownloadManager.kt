...
class DownloadManager(
    ...
    suspend fun verifyAndMarkChapterIfComplete(
        ...
        // Get manga directory for adding to cache
        val mangaDir = provider.findMangaDir(manga.title, source) ?: return false

        // Get valid chapter directory name
        val chapterDirName = chapterDir.name ?: return false
